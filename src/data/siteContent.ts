...
export const defaultSiteContent: SiteContent = {
  ...
  socialLinks: [
    ...
    { name: 'LinkedIn', url: 'https://www.linkedin.com/in/linfairwool/', enabled: true },
    { name: 'Pinterest', url: 'https://www.pinterest.com/linfairwools/', enabled: true },
    { name: 'YouTube', url: 'https://www.youtube.com/@linfairwool', enabled: true },
    { name: 'TikTok', url: 'https://www.tiktok.com/@linfairsweaters', enabled: true },
    { name: 'Twitter/X', url: 'https://x.com/linfairwooles', enabled: true },
  ],
  navItems: [
