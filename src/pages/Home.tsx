    ...
    <>
      ...
      <section className="relative min-h-[100svh] flex items-center bg-primary overflow-hidden">
        <div className="absolute inset-0">
          <img src="/images/factory-production-floor.jpg" alt="LINFAIR Knitwear Factory" width="780" height="470" {...({ fetchpriority: 'high' } as any)} className="w-full h-full object-cover" />
