    ...
    <div className="min-h-screen flex flex-col">
      ...
      {whatsapp && (
        <a
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:bg-[#20BD5A] hover:scale-110 transition-all duration-300 group"
      ...
      <AnimatePresence>
        {showBackToTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-6 left-6 z-50 w-12 h-12 bg-primary/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-primary transition-all duration-300"
            title="Back to top"
          >
